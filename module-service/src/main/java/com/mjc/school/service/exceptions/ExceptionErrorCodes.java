...
public enum ExceptionErrorCodes {
    ...
    CONTENT_LENGTH_IS_WRONG(Constants.ERROR_CODE_000004, "Content length is wrong. Content field should have length of value from 5 to 255. News content is %s"),
    ...
    ID_IS_WRONG(Constants.ERROR_CODE_000005, "%s Id should be a number greater than 0"),
    FIELD_IS_REQUIRED(Constants.ERROR_CODE_000007, "Field %s cannot be null");
